    ...
    <div class="card mt-3">
      <div class="card-header ">
        ...
        <div class=" col-sm-12 col-md-12 col-lg-12 fw-bold text-center text primary">
          <button type="button" class="btn btn-sm mb-2 float-sm-start" data-toggle="modal" data-target="#addnewproduct"
            data-bs-toggle="tooltip" title="Add Product">
            <i class="material-icons text-success">add</i></button>
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        ...
        <?php
            ...
            ?>
        <table class="table table-bordered table-hover" style="overflow-y: scroll;" id="datatable"">
          <thead>
          ...
          <tbody>
            ...
            <td><?= $row['category'] ?></td>
              ...
              <td><?= "<img src='assets/img/new-product/".$row['productImage']."' >"; ?></td>
              <td>&#8369; <?= $row['productPrice'] ?></td>

              <td>
                <button type="button" class="btn btn-sm btn-outline-success mx-3" data-bs-toggle="modal" data-bs-target="#edit<?= $row['id']?>">
                  edit
                </button>
                <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $row['id'] ?>">
                  delete
                </button>
              </td>
